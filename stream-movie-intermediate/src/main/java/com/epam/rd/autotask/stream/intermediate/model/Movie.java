...
public class Movie implements Comparable<Movie> {
    ...
    public int compareTo(Movie o) {
        int toReturn=0;
        List<Person> directors1 = this.getDirectors();
        List<Person> directors2 = o.getDirectors();
        for (Person p : directors1){
            for (Person person : directors2){
                toReturn = p.getDateOfBirth().compareTo(person.getDateOfBirth());
            }
        }
        return toReturn;
    }
